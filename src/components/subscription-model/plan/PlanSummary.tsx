...
const PlanSummary = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'components' | 'agents'>('overview');
  ...
  // isFetching will be true whenever data is being fetched (initial or refetch)
  // isLoading is only true on initial fetch when there's no cached data
  const {
    data: summaryData,
    ...
    skip: !selectedPlanId, // Skip the query if no plan is selected
  });
  ...
  // Show loading only when fetching and no data available yet
  ...
  return (
    <div className="w-full min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Loading State - Only show when fetching and no data */}
        ...
        {/* Summary Content - Show immediately with cached data or after loading */}
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between py-3 border-b border-gray-100">
                  <span className="text-gray-700">
                    Components Value
                    <span className="ml-2 text-xs text-gray-500">({summaryData.components.count} items)</span>
                  </span>
                ...
                <div className="flex items-center justify-between py-3 border-b border-gray-100">
                  <span className="text-gray-700">
                    Agents Value
                    <span className="ml-2 text-xs text-gray-500">({summaryData.agents.count} items)</span>
                  </span>
                  <span className="font-semibold text-green-600">
                    + {formatPrice(summaryData.pricing_summary.agents_value)}
                  </span>
                </div>
                <div className="flex items-center justify-between py-4 bg-gradient-to-r from-indigo-50 to-purple-50 -mx-6 px-6 rounded-xl mt-4">
                  <span className="text-lg font-bold text-gray-900">Total Plan Value</span>
                              ...
                              <div className="flex items-start gap-4 flex-1">
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
                                    <div>
                                      <div className="text-xs text-gray-500">Base Quantity</div>
                                      <div className="font-medium text-gray-900">
                                        {formatQuantity(component.base_quantity, component.unit_label)}
                                      </div>
                                    </div>
                                    <div>
                                      <div className="text-xs text-gray-500">Multiplier</div>
                                      <div className="font-medium text-indigo-600">×{component.quantity_multiplier}</div>
                                    </div>
                                    <div>
                                      <div className="text-xs text-gray-500">Total Quantity</div>
                                      <div className="font-semibold text-gray-900">
                                        {formatQuantity(component.total_quantity, component.unit_label)}
                                      </div>
                                    </div>
                                    <div>
                                      <div className="text-xs text-gray-500">Total Price</div>
                                      <div className="font-semibold text-green-600">
                                        {formatPrice(component.total_price)}
                                      </div>
                                    </div>
                                  </div>
                                  <div className="flex items-center gap-3 mt-3">
                                    <span className="text-xs text-gray-500">
                                      Price per unit: {formatPrice(component.price_per_unit)}
                                    </span>
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm">
                                    ...
                                    <div>
                                      ...
                                      <div className="font-medium text-indigo-600">×{agent.included_instances}</div>
                                    </div>
                                    <div>
                                      <div className="text-xs text-gray-500">Total Price</div>
                                      <div className="font-semibold text-green-600">
                                    ...
                                    <div>
                                      ...
                                      <div className="font-medium text-gray-900">
                                        {agent.estimated_tokens_per_use.toLocaleString()}
                                      </div>
                                    </div>
                                  </div>
                                  <div className="flex items-center gap-3 mt-3">
                                    ...
                                    <span className="text-xs text-gray-500">
                                      Storage: {agent.estimated_storage_mb} MB
                                    </span>
                                    <span className="text-xs text-gray-500">
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl">
                <div className="text-sm text-gray-700">
                  ...
                  <ul className="text-left space-y-1 text-xs">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-indigo-600">✓</span>
                      <span>All included components with quantities and values</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-indigo-600">✓</span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-indigo-600">✓</span>
                      <span>Subscription statistics and metadata</span>
                    </li>
                  </ul>
                </div>
              </div>
